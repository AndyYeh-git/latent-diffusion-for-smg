...
if __name__ == '__main__':
    ...
    for filename in os.listdir(f'{hyp_prefix}/'):
        try:
            ...
            alignment = dtw(d1, d2, keep_internals=True)
            print(f'DTW distance : {alignment.distance / len(d2)}')
            dtw_mean.append(alignment.distance / len(d2))
        except BaseException as e:
            continue
    print(f'dtw_mean : {dtw_mean}')
