...
def main(args):
    ...
    assert args.seg * args.num_encoder_latents==32
    ...
    if args.only_bart:
        trainer.load(args.resume_dir, only_bart=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_encoder_latents", type=int, default=8)
    parser.add_argument("--num_decoder_latents", type=int, default=8)
    ...
    parser.add_argument("--only_bart", action="store_true", default=False)
    ...
    if args.eval or args.resume_training:
        ...
        args_dict = vars(args)
        heldout_params = {'wandb_name', 'output_dir', 'resume_dir', 'eval', 'resume_training', 'only_bart'}
